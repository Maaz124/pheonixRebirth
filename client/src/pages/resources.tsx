...
const generatePDF = (resource: Resource) => {
  ...
  doc.text("Therapeutic Resource Library", pageWidth / 2, 30, {
    align: "center",
  });
  ...
  doc.text(
    `Type: ${resource.type}  |  Duration: ${resource.duration}  |  Level: ${resource.difficulty}`,
    margin,
    yPosition,
  );
  yPosition += 12;
  ...
  doc.text(
    "© The Phoenix Method™ - Trauma Recovery Program for Women",
    pageWidth / 2,
    yPosition,
    { align: "center" },
  );
  ...
  doc.save(
    `${resource.title.replace(/[^a-zA-Z0-9]/g, "_")}_Phoenix_Method.pdf`,
  );
};
  ...
  mindfulness: [
    {
      ...
      description:
        "A powerful sensory grounding exercise to manage anxiety and panic attacks",
      type: "Technique",
      duration: "2-5 minutes",
      difficulty: "Beginner",
      content: {
        overview:
          "The 5-4-3-2-1 technique helps you ground yourself in the present moment by engaging all five senses. This technique is particularly effective during anxiety attacks, dissociation, or overwhelming emotions.",
        steps: [
        ...
        whenToUse:
          "During anxiety attacks, panic attacks, dissociation, overwhelm, or anytime you need to feel more present and grounded.",
      },
    },
    {
      id: 2,
      ...
      description:
        "A simple yet powerful breathing technique used by Navy SEALs and trauma therapists",
      type: "Breathing Exercise",
      duration: "3-10 minutes",
      difficulty: "Beginner",
      content: {
        overview:
          "Box breathing, also known as square breathing, is a technique that helps regulate your nervous system by slowing down your breathing pattern. It activates the parasympathetic nervous system, promoting calm and focus.",
        steps: [
        ...
        whenToUse:
          "Before stressful situations, during anxiety, to improve focus, or as part of your daily mindfulness routine.",
      },
    },
    {
      id: 3,
      ...
      description:
        "A progressive relaxation technique to release tension and develop body awareness",
      type: "Meditation",
      duration: "10-30 minutes",
      difficulty: "Intermediate",
      content: {
        overview:
          "Body scan meditation helps you develop awareness of physical sensations and release stored tension. This practice is particularly healing for trauma survivors as it helps reconnect with the body in a gentle, non-threatening way.",
        steps: [
        ...
        whenToUse:
          "Before sleep, when feeling disconnected from your body, or to develop greater self-awareness and relaxation.",
      },
    },
  ],
  cbt: [
    {
      ...
      description:
        "Identify and challenge negative thought patterns with this CBT core technique",
      type: "Worksheet",
      duration: "10-20 minutes",
      difficulty: "Intermediate",
      content: {
        overview:
          "Thought records help you identify the connection between thoughts, feelings, and behaviors. This technique is fundamental to CBT and helps you develop awareness of automatic negative thoughts and learn to challenge them with evidence.",
        steps: [
        ...
        whenToUse:
          "When you notice strong emotional reactions, recurring negative thoughts, or want to understand your thought patterns better.",
      },
    },
    {
      id: 5,
      ...
      description:
        "Learn to identify the 10 most common thinking traps that fuel anxiety and depression",
      type: "Educational",
      duration: "15 minutes to learn",
      difficulty: "Beginner",
      content: {
        overview:
          "Cognitive distortions are inaccurate thought patterns that reinforce negative emotions. Learning to identify these patterns is the first step in changing them.",
        steps: [
        ...
        whenToUse:
          "Daily self-reflection, during therapy sessions, or whenever you notice strong negative emotions.",
      },
    },
    {
      id: 6,
      ...
      description:
        "Combat depression and trauma withdrawal by scheduling meaningful activities",
      type: "Planning Tool",
      duration: "20-30 minutes weekly",
      difficulty: "Intermediate",
      content: {
        overview:
          "Behavioral activation helps combat depression and trauma-related withdrawal by gradually reintroducing meaningful activities into your life. The goal is to increase positive experiences and break the cycle of avoidance.",
        steps: [
        ...
        whenToUse:
          "When feeling depressed, isolated, or stuck in avoidance patterns. Particularly helpful for trauma survivors who have withdrawn from previously enjoyed activities.",
      },
    },
  ],
  nlp: [
    {
      ...
      description:
        "Create instant access to resourceful emotional states when you need them most",
      type: "Technique",
      duration: "15-20 minutes to set up",
      difficulty: "Intermediate",
      content: {
        overview:
          "Anchoring allows you to associate a specific physical touch or gesture with a desired emotional state. Once established, you can trigger this positive state whenever needed, giving you more control over your emotional responses.",
        steps: [
        ...
        whenToUse:
          "Before challenging situations, during anxiety or stress, when you need confidence, or to change your emotional state quickly.",
      },
    },
    {
      id: 8,
      ...
      description:
        "Transform limiting beliefs and negative perspectives into empowering ones",
      type: "Cognitive Technique",
      duration: "10-15 minutes",
      difficulty: "Intermediate",
      content: {
        overview:
          "Reframing helps you look at situations from different perspectives, particularly changing disempowering viewpoints into more resourceful ones. This technique is especially powerful for addressing limiting beliefs formed during trauma.",
        steps: [
        ...
        whenToUse:
          "When stuck in negative thinking patterns, facing challenges, or working to change limiting beliefs about yourself or your capabilities.",
      },
    },
    {
      id: 9,
      ...
      description:
        "Connect with your healed future self for guidance and motivation",
      type: "Visualization",
      duration: "15-25 minutes",
      difficulty: "Advanced",
      content: {
        overview:
          "This powerful visualization technique helps you connect with your future healed self, gaining wisdom, motivation, and hope. It's particularly transformative for trauma survivors who struggle to envision a positive future.",
        steps: [
        ...
        whenToUse:
          "When feeling hopeless about the future, needing guidance on decisions, or wanting motivation to continue your healing journey.",
      },
    },
  ],
  trauma: [
    {
      ...
      description:
        "Learn to recognize and expand your optimal zone of arousal for emotional regulation",
      type: "Educational Tool",
      duration: "10 minutes to learn",
      difficulty: "Beginner",
      content: {
        overview:
          "The Window of Tolerance concept helps you understand your nervous system's capacity to handle stress and emotions. When you're within your window, you can think clearly and respond flexibly. Outside your window, you're either hyperaroused (anxious, panicked) or hypoaroused (numb, disconnected).",
        steps: [
        ...
        whenToUse:
          "Daily self-monitoring, when feeling overwhelmed or numb, and as a framework for understanding your emotional responses.",
      },
    },
    {
      id: 11,
      ...
      description:
        "Emergency techniques to quickly change your body chemistry during emotional crisis",
      type: "Crisis Tool",
      duration: "5-15 minutes",
      difficulty: "Beginner",
      content: {
        overview:
          "TIPP (Temperature, Intense Exercise, Paced Breathing, Progressive Relaxation) skills are designed to quickly change your body chemistry when you're in emotional crisis. These techniques work by activating your parasympathetic nervous system.",
        steps: [
        ...
        whenToUse:
          "During panic attacks, intense emotional distress, self-harm urges, or when you feel completely overwhelmed.",
      },
    },
    {
      id: 12,
      ...
      description:
        "Gentle movement practices that honor your body's wisdom and promote safety",
      type: "Movement Practice",
      duration: "15-30 minutes",
      difficulty: "Beginner",
      content: {
        overview:
          "Trauma-informed yoga emphasizes choice, safety, and body awareness. This sequence helps you reconnect with your body gently, building strength and flexibility while respecting your boundaries.",
        steps: [
        ...
        whenToUse:
          "When feeling disconnected from your body, to release stored tension, or as part of a regular self-care routine.",
      },
    },
  ],
  worksheets: [
    {
      ...
      description:
        "Comprehensive tool to assess current boundaries and create a plan for healthier ones",
      type: "Assessment",
      duration: "30-45 minutes",
      difficulty: "Intermediate",
      content: {
        overview:
          "This worksheet helps you evaluate your current boundaries across different life areas and create specific plans for improvement. It's designed to help you move from boundary confusion to boundary clarity.",
        steps: [
        ...
        whenToUse:
          "When starting boundary work, feeling overwhelmed by others' demands, or preparing for difficult conversations.",
      },
    },
    {
      id: 14,
      ...
      description:
        "Structured practice for treating yourself with kindness during difficult moments",
      type: "Practice Guide",
      duration: "5-10 minutes per use",
      difficulty: "Beginner",
      content: {
        overview:
          "Based on Kristin Neff's research, this worksheet guides you through the three components of self-compassion: mindfulness, common humanity, and self-kindness. It's particularly healing for trauma survivors who struggle with self-criticism.",
        steps: [
        ...
        whenToUse:
          "During self-critical moments, after making mistakes, when facing challenges, or anytime you need emotional support.",
      },
    },
    {
      id: 15,
      ...
      description:
        "Track patterns in your emotional and physical well-being to identify triggers and resources",
      type: "Tracking Sheet",
      duration: "2-5 minutes daily",
      difficulty: "Beginner",
      content: {
        overview:
          "Regular mood and energy tracking helps you identify patterns, triggers, and what supports your well-being. This awareness is crucial for making informed decisions about your daily activities and self-care.",
        steps: [
        ...
        whenToUse:
          "Daily tracking, especially when starting therapy, changing medications, or working to understand your patterns better.",
      },
    },
  ],
  videos: [
    {
      ...
      description:
        "20-minute video guide to systematically release tension from your entire body",
      type: "Guided Practice",
      duration: "20 minutes",
      difficulty: "Beginner",
      content: {
        overview:
          "Progressive Muscle Relaxation (PMR) teaches you to recognize the difference between tension and relaxation by systematically tensing and then releasing different muscle groups. This practice is excellent for anxiety, sleep issues, and general stress relief.",
        steps: [
        ...
        whenToUse:
          "Before sleep, during high stress periods, or when you notice physical tension from anxiety or trauma.",
      },
    },
    {
      id: 17,
      ...
      description:
        "Cultivate compassion for yourself and others through this ancient Buddhist practice",
      type: "Meditation",
      duration: "15 minutes",
      difficulty: "Intermediate",
      content: {
        overview:
          "Loving-kindness meditation helps heal the inner critic and develop genuine self-compassion. For trauma survivors, this practice can be initially challenging but ultimately deeply healing as it rewires patterns of self-judgment.",
        steps: [
        ...
        whenToUse:
          "When struggling with self-criticism, feeling disconnected from others, or as part of regular meditation practice.",
      },
    },
    {
      id: 18,
      ...
      description:
        "Learn Emotional Freedom Technique to quickly reduce anxiety and emotional intensity",
      type: "Technique Training",
      duration: "12 minutes",
      difficulty: "Beginner",
      content: {
        overview:
          "EFT (Emotional Freedom Technique) combines ancient Chinese acupressure with modern psychology. By tapping on specific meridian points while focusing on your issue, you can quickly reduce emotional intensity and anxiety.",
        steps: [
        ...
        whenToUse:
          "During anxiety attacks, before stressful events, when feeling emotionally overwhelmed, or for ongoing anxiety management.",
      },
    },
  ],
};
...
export default function Resources() {
  ...
  const filteredResources =
    therapeuticResources[
      selectedCategory as keyof typeof therapeuticResources
    ]?.filter(
      (resource) =>
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3 pt-4">
              ...
              >
                <Star
                  size={16}
                  className={`mr-2 ${isBookmarked(resource.id) ? "fill-current" : ""}`}
                />
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Comprehensive collection of evidence-based techniques, worksheets,
            and tools for trauma recovery. All resources are trauma-informed and
      ...
      <section className="px-4 pb-16">
        <div className="max-w-6xl mx-auto">
          ...
          >
                ...
                {bookmarks.length === 0 ? (
                  <Card className="p-12 text-center">
                    ...
                    <p className="text-gray-500 mb-4">
                      Bookmark your favorite techniques by clicking the Bookmark
                      button in any resource.
                    </p>
                    <Button
                      variant="outline"
                  ...
                  Object.values(therapeuticResources)
                    .flat()
            ...
            {Object.entries(therapeuticResources).map(
              ([category, resources]) => (
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <Card className="p-4 text-center hover:shadow-lg transition-shadow cursor-pointer bg-gradient-to-br from-orange-50 to-red-50">
              ...
              <p className="text-sm text-gray-600">
                Set healthy limits with confidence
              </p>
            </Card>
          </div>
        </div>
